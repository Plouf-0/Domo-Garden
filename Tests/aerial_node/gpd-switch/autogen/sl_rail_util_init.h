...
#include "rail.h"
#include "sl_rail_util_init_gpdrail_config.h"
 ...
 * run-time.
 */
#define SL_RAIL_UTIL_INIT_EVENT_GPDRAIL_MASK (RAIL_EVENTS_NONE              \
  | (SL_RAIL_UTIL_INIT_EVENT_RSSI_AVERAGE_DONE_GPDRAIL_ENABLE               \
    ? RAIL_EVENT_RSSI_AVERAGE_DONE : RAIL_EVENTS_NONE)                                 \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_ACK_TIMEOUT_GPDRAIL_ENABLE                  \
    ? RAIL_EVENT_RX_ACK_TIMEOUT : RAIL_EVENTS_NONE)                                    \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_FIFO_ALMOST_FULL_GPDRAIL_ENABLE             \
    ? RAIL_EVENT_RX_FIFO_ALMOST_FULL : RAIL_EVENTS_NONE)                               \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_PACKET_RECEIVED_GPDRAIL_ENABLE              \
    ? RAIL_EVENT_RX_PACKET_RECEIVED : RAIL_EVENTS_NONE)                                \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_PREAMBLE_LOST_GPDRAIL_ENABLE                \
    ? RAIL_EVENT_RX_PREAMBLE_LOST : RAIL_EVENTS_NONE)                                  \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_PREAMBLE_DETECT_GPDRAIL_ENABLE              \
    ? RAIL_EVENT_RX_PREAMBLE_DETECT : RAIL_EVENTS_NONE)                                \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_SYNC1_DETECT_GPDRAIL_ENABLE                 \
    ? RAIL_EVENT_RX_SYNC1_DETECT : RAIL_EVENTS_NONE)                                   \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_SYNC2_DETECT_GPDRAIL_ENABLE                 \
    ? RAIL_EVENT_RX_SYNC2_DETECT : RAIL_EVENTS_NONE)                                   \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_FRAME_ERROR_GPDRAIL_ENABLE                  \
    ? RAIL_EVENT_RX_FRAME_ERROR : RAIL_EVENTS_NONE)                                    \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_FIFO_FULL_GPDRAIL_ENABLE                    \
    ? RAIL_EVENT_RX_FIFO_FULL : RAIL_EVENTS_NONE)                                      \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_FIFO_OVERFLOW_GPDRAIL_ENABLE                \
    ? RAIL_EVENT_RX_FIFO_OVERFLOW : RAIL_EVENTS_NONE)                                  \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_ADDRESS_FILTERED_GPDRAIL_ENABLE             \
    ? RAIL_EVENT_RX_ADDRESS_FILTERED : RAIL_EVENTS_NONE)                               \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_TIMEOUT_GPDRAIL_ENABLE                      \
    ? RAIL_EVENT_RX_TIMEOUT : RAIL_EVENTS_NONE)                                        \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_TX_SCHEDULED_RX_TX_STARTED_GPDRAIL_ENABLE   \
    ? RAIL_EVENT_SCHEDULED_RX_STARTED : RAIL_EVENTS_NONE)                              \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_SCHEDULED_RX_END_GPDRAIL_ENABLE             \
    ? RAIL_EVENT_RX_SCHEDULED_RX_END : RAIL_EVENTS_NONE)                               \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_SCHEDULED_RX_MISSED_GPDRAIL_ENABLE          \
    ? RAIL_EVENT_RX_SCHEDULED_RX_MISSED : RAIL_EVENTS_NONE)                            \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_PACKET_ABORTED_GPDRAIL_ENABLE               \
    ? RAIL_EVENT_RX_PACKET_ABORTED : RAIL_EVENTS_NONE)                                 \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_FILTER_PASSED_GPDRAIL_ENABLE                \
    ? RAIL_EVENT_RX_FILTER_PASSED : RAIL_EVENTS_NONE)                                  \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_TIMING_LOST_GPDRAIL_ENABLE                  \
    ? RAIL_EVENT_RX_TIMING_LOST : RAIL_EVENTS_NONE)                                    \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_TIMING_DETECT_GPDRAIL_ENABLE                \
    ? RAIL_EVENT_RX_TIMING_DETECT : RAIL_EVENTS_NONE)                                  \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_CHANNEL_HOPPING_COMPLETE_GPDRAIL_ENABLE     \
    ? RAIL_EVENT_RX_CHANNEL_HOPPING_COMPLETE : RAIL_EVENTS_NONE)                       \
  | (SL_RAIL_UTIL_INIT_EVENT_RX_DUTY_CYCLE_RX_END_GPDRAIL_ENABLE            \
    ? RAIL_EVENT_RX_DUTY_CYCLE_RX_END : RAIL_EVENTS_NONE)                              \
  | (SL_RAIL_UTIL_INIT_EVENT_IEEE802154_DATA_REQUEST_COMMAND_GPDRAIL_ENABLE \
    ? RAIL_EVENT_IEEE802154_DATA_REQUEST_COMMAND : RAIL_EVENTS_NONE)                   \
  | (SL_RAIL_UTIL_INIT_EVENT_ZWAVE_BEAM_GPDRAIL_ENABLE                      \
    ? RAIL_EVENT_ZWAVE_BEAM : RAIL_EVENTS_NONE)                                        \
  | (SL_RAIL_UTIL_INIT_EVENT_ZWAVE_LR_ACK_REQUEST_COMMAND_GPDRAIL_ENABLE    \
    ? RAIL_EVENT_ZWAVE_LR_ACK_REQUEST_COMMAND : RAIL_EVENTS_NONE)                      \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_FIFO_ALMOST_EMPTY_GPDRAIL_ENABLE            \
    ? RAIL_EVENT_TX_FIFO_ALMOST_EMPTY : RAIL_EVENTS_NONE)                              \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_PACKET_SENT_GPDRAIL_ENABLE                  \
    ? RAIL_EVENT_TX_PACKET_SENT : RAIL_EVENTS_NONE)                                    \
  | (SL_RAIL_UTIL_INIT_EVENT_TXACK_PACKET_SENT_GPDRAIL_ENABLE               \
    ? RAIL_EVENT_TXACK_PACKET_SENT : RAIL_EVENTS_NONE)                                 \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_ABORTED_GPDRAIL_ENABLE                      \
    ? RAIL_EVENT_TX_ABORTED : RAIL_EVENTS_NONE)                                        \
  | (SL_RAIL_UTIL_INIT_EVENT_TXACK_ABORTED_GPDRAIL_ENABLE                   \
    ? RAIL_EVENT_TXACK_ABORTED : RAIL_EVENTS_NONE)                                     \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_BLOCKED_GPDRAIL_ENABLE                      \
    ? RAIL_EVENT_TX_BLOCKED : RAIL_EVENTS_NONE)                                        \
  | (SL_RAIL_UTIL_INIT_EVENT_TXACK_BLOCKED_GPDRAIL_ENABLE                   \
    ? RAIL_EVENT_TXACK_BLOCKED : RAIL_EVENTS_NONE)                                     \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_UNDERFLOW_GPDRAIL_ENABLE                    \
    ? RAIL_EVENT_TX_UNDERFLOW : RAIL_EVENTS_NONE)                                      \
  | (SL_RAIL_UTIL_INIT_EVENT_TXACK_UNDERFLOW_GPDRAIL_ENABLE                 \
    ? RAIL_EVENT_TXACK_UNDERFLOW : RAIL_EVENTS_NONE)                                   \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_CHANNEL_CLEAR_GPDRAIL_ENABLE                \
    ? RAIL_EVENT_TX_CHANNEL_CLEAR  : RAIL_EVENTS_NONE)                                 \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_CHANNEL_BUSY_GPDRAIL_ENABLE                 \
    ? RAIL_EVENT_TX_CHANNEL_BUSY : RAIL_EVENTS_NONE)                                   \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_CCA_RETRY_GPDRAIL_ENABLE                    \
    ? RAIL_EVENT_TX_CCA_RETRY : RAIL_EVENTS_NONE)                                      \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_START_CCA_GPDRAIL_ENABLE                    \
    ? RAIL_EVENT_TX_START_CCA : RAIL_EVENTS_NONE)                                      \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_STARTED_GPDRAIL_ENABLE                      \
    ? RAIL_EVENT_TX_STARTED : RAIL_EVENTS_NONE)                                        \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_SCHEDULED_TX_MISSED_GPDRAIL_ENABLE          \
    ? RAIL_EVENT_TX_SCHEDULED_TX_MISSED : RAIL_EVENTS_NONE)                            \
  | (SL_RAIL_UTIL_INIT_EVENT_CONFIG_UNSCHEDULED_GPDRAIL_ENABLE              \
    ? RAIL_EVENT_CONFIG_UNSCHEDULED : RAIL_EVENTS_NONE)                                \
  | (SL_RAIL_UTIL_INIT_EVENT_CONFIG_SCHEDULED_GPDRAIL_ENABLE                \
    ? RAIL_EVENT_CONFIG_SCHEDULED : RAIL_EVENTS_NONE)                                  \
  | (SL_RAIL_UTIL_INIT_EVENT_SCHEDULER_STATUS_GPDRAIL_ENABLE                \
    ? RAIL_EVENT_SCHEDULER_STATUS : RAIL_EVENTS_NONE)                                  \
  | (SL_RAIL_UTIL_INIT_EVENT_CAL_NEEDED_GPDRAIL_ENABLE                      \
    ? RAIL_EVENT_CAL_NEEDED : RAIL_EVENTS_NONE)                                        \
  | (SL_RAIL_UTIL_INIT_EVENT_DETECT_RSSI_THRESHOLD_GPDRAIL_ENABLE           \
    ? RAIL_EVENT_DETECT_RSSI_THRESHOLD : RAIL_EVENTS_NONE)                             \
  | (SL_RAIL_UTIL_INIT_EVENT_THERMISTOR_DONE_GPDRAIL_ENABLE                 \
    ? RAIL_EVENT_THERMISTOR_DONE : RAIL_EVENTS_NONE)                                   \
  | (SL_RAIL_UTIL_INIT_EVENT_TX_BLOCKED_TOO_HOT_GPDRAIL_ENABLE              \
    ? RAIL_EVENT_TX_BLOCKED_TOO_HOT : RAIL_EVENTS_NONE)                                \
  | (SL_RAIL_UTIL_INIT_EVENT_TEMPERATURE_TOO_HOT_GPDRAIL_ENABLE             \
    ? RAIL_EVENT_TEMPERATURE_TOO_HOT : RAIL_EVENTS_NONE)                               \
  | (SL_RAIL_UTIL_INIT_EVENT_TEMPERATURE_COOL_DOWN_GPDRAIL_ENABLE           \
 ...
 * run-time.
 */
#define SL_RAIL_UTIL_INIT_EVENT_GPDRAIL_INVERSE_MASK \
  (~SL_RAIL_UTIL_INIT_EVENT_GPDRAIL_MASK)
